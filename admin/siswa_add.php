...
<head>
  ...
  <link rel="stylesheet" href="/style/addSiswa.css">
</head>
      ...
      <div class="sidebar">
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column">
            ...
            <li class="nav-item">
              <a href="aspirasi_list.php" class="nav-link">
            ...
            <li class="nav-item">
              <a href="siswa_add.php" class="nav-link active">
                          ...
                          <form method="POST">
                            ...
                            <div class="modal-body">
                              ...
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?= $s['nis'] ?>" disabled>
                              </div>
                              ...
                              <div class="form-group">
                                <label>Password</label>
                                <input type="text" name="password" class="form-control" value="<?= $s['password'] ?>" required>
                              </div>
